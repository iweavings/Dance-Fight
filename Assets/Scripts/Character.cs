...
public class Character : MonoBehaviour
{
    ...
    [Header("Stats")]
    public int availablePoints; // The total amount of points we want to assign to our stats!
    ...
    private void SetUpInitialCharacterStats()
    {
      //Debug.LogWarning("InitialStats called, needs to distribute points into stats. This should be able to be ported from previous brief work");
        ...
        // for each available point, choose a random stat and give it a a point

        for (int i = availablePoints; i > 0; i--)
        {
        ...
        Debug.LogWarning("style = " + style);
        Debug.LogWarning("luck = " + luck);
        Debug.LogWarning("rhythm = " + rhythm);
    ...
    public int ReturnBattlePoints()
    {
        ...
        int battlePoints = ((style * 2) + (rhythm * 3)) + luck;
        Debug.LogWarning("Battlepoints for " + charName + " is " + battlePoints);
