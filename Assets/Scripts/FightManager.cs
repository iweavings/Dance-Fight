...
public class FightManager : MonoBehaviour
{
    ...
    public Color winCol = Color.blue; //winners are blue
    ...
    IEnumerator Attack(Character teamACharacter, Character teamBCharacter)
    {
        ...
        yield return new WaitForSeconds(fightAnimTime);
        {
            ...
            int totalPoints = teamABattlePoints + teamBBattlePoints;
            ...
            if (teamABattlePoints > teamBBattlePoints)
            {
                ...
                outcome = teamABattlePoints / totalPoints;
                //if team A won, the outcome is equal to team A's points divided by total points.
            }
            if (teamBBattlePoints > teamABattlePoints)
            {
                winner = teamBCharacter;
                defeated = teamACharacter;
                outcome = teamBBattlePoints / totalPoints; //vice versa
            }
